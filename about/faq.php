...
<body class="home-one">
    ...
    <!-- <section id="slider-section" class="header-bg" >
        <div class="" style="background-image: url('assets/img/bg/portfolio-header.jpg');">
            <div class="container">
                <div class="row">
                    <img src="assets/img/bg/portfolio-header.jpg">
                </div>
            </div>
        </div>
    </section> -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="animated wow  fadeInUp" data-wow-duration="2s" data-wow-delay=".5s">Frequently Asked Questions</h2>
                        <p class="animated wow  fadeInUp" data-wow-duration="2s" data-wow-delay=".6s">We are proud to be a awesome theam. They are really awespme people with their good knoledge.</p>
                    </div>
                </div>
            </div>    <!--TAB AREA-->
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="tabs animated-slide-2">
                                <ul class="nav nav-tabs animated wow  fadeInUp" data-wow-duration="2s" data-wow-delay=".7s" role="tablist">
