...
if(isset($_POST['submit']))
        ...
        $query = "INSERT INTO `enquiry`(`service`,`name`, `email`, `contact`, `company_name`, `website`, `budget`, `msg`) 
        VALUES ('$service','$name','$email',$contact,'$company','$website','$budget','$msg')";
       // echo $query;
...
<head>
    ...
    <title>NLP Cube | Enquiry Successfull</title>
...
<section id="countdown-area" class="countdown-area homepage-3 homepage-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="countdown-table wow fadeInUp" data-wow-duration="2s" data-wow-delay=".25s">
                        <div class="countdown-table-cell">
                            <h2 class="token">Enquiry made Successfully</h2>
							<h4>Our team will get back to you soon.</h4>
                            

                            <div class="post-meta clearfix">
                                
                                <div class="buy-coin pull-right">
                                    <a href="index.php" class="buy-coin-btn">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
