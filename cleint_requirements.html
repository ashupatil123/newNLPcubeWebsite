...
<div class="col-md-6 col-md-offset-3 details">
	...
	<div class="row">
		...
		<?php
			...
			<br /><b>What type of Application need to be developed?</b><br />"

			?>
		<?php
			foreach(@$_POST['type'] as $value2) { echo $value2.' '; }
			...
			?>
			<?php
				foreach(@$_POST['login1'] as $value1) { echo $value1.' '; } 
			...
			?>
			<?php
				foreach(@$_POST['type1'] as $value4) { echo $value4.' '; }
	...
	$query = "INSERT INTO `quote`(`name`, `email`, `phone`, `int_service`, `msg`, `service`, `type`, `login`, `register`, `app-money`, `connect-app`, `app-look`, `app-budget`, `website`, `pages`, `admin-panel`, `ecommerce`, `template`, `logo`, `web-budget`,`type1`,`login1`, `register1`, `app-money1`, `connect-app1`, `app-look1`, `website1`, `pages1`, `admin-panel1`, `ecommerce1`, `template1`, `logo1`, `both-budget`) VALUES ('$name','$email','$phone','$value3','$msg','$service','$value2','$value','$register','$app_money','$connect_app','$app_look','$app_budget','$website','$pages','$admin_panel','$ecommerce','$template','$logo','$web_budget','$value4','$value1','$register1','$app_money1','$connect_app1','$app_look1','$website1','$pages1','$admin_panel1','$ecommerce1','$template1','$logo1','$both_budget')";
